...
test('index loads market, lexicon, continuous flow, state visuals and UX layers in dependency order', () => {
  ...
  assert.match(html, /name="cwt-build" content="2026-09-20-north-forest-feedback3"/);
  ...
  assert.match(html, /market-late-content\.js\?v=20260912-marketm8r3/); assert.match(html, /market-runtime\.js\?v=20260914-directinspect1/); assert.match(html, /market-state-visuals\.js\?v=20260912-marketm8r3/); assert.match(html, /market-state-visuals\.css\?v=20260912-marketm8r3/); assert.match(html, /continuous-region-flow\.js\?v=20260912-uxflow1/); assert.match(html, /ux-play-runtime\.js\?v=20260920-feedback1/);
});
