...
test('index loads market, lexicon, continuous flow, state visuals and UX layers in dependency order', () => {
  ...
  assert.match(html, /name="cwt-build" content="2026-09-25-academic-tower-expectation-sort1"/);
  assert.match(html, /lexicon-content\.js\?v=20260925-expectationsort1/); assert.match(html, /lexicon-runtime\.js\?v=20260913-lexicon1/); assert.match(html, /lexicon\.css\?v=20260913-lexicon2/);
