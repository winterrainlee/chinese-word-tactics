  ...
  Object.assign(stories, {
    'workshop-w4-setup': {
      ...
      beats: [
        ...
        { speaker: 'artisan', zh: '不是。三個地方各有自己的要求。先別動，看看哪裡已經沒問題。', ko: '아니. 세 곳마다 맞춰야 할 조건이 달라. 바로 손대지 말고, 어디가 이미 괜찮은지부터 봐.' },
        { speaker: 'artisan', zh: '我去把工具理好。剩下的你照著工作臺旁的標示判斷。', ko: '나는 공구를 정리할게. 필요한 상태는 작업대 옆 표시를 보고 네가 판단해 봐.' }
      ]
    },
    'workshop-after-w4': {
    ...
    'workshop-before-core': {
      ...
      beats: [
        ...
        { speaker: 'boy', zh: '我先自己看一遍。', ko: '먼저 제가 전체를 한 번 볼게요.' },
        { speaker: 'artisan', zh: '好。這次我不提醒你哪裡要動。你自己決定。', ko: '그래. 이번엔 어디를 손대야 하는지 내가 먼저 말하지 않을게. 네가 판단해 봐.' }
      ]
    },
    'workshop-finale': {
