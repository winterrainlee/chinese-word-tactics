  ...
  Object.assign(globalThis.JourneyContent.STORIES, {
    'north-forest-signs-request': {
      ...
      background: 'inn', placeZh: '客棧', placeKo: '여관 게시판', beats: [
        ...
        { speaker: 'innkeeper', zh: '差不多。你去過一次，應該認得入口。採集人還坐在窗邊，你願意接的話，先去跟他問清楚吧。', ko: '대충 그쪽이야. 한번 다녀왔으니 입구 정도는 알아보겠지. 채집인이 아직 창가에 있으니, 맡아 볼 거면 먼저 가서 자세히 물어봐.' },
        { speaker: 'narrator', zh: '少年走到窗邊，向正在整理籃子的採集人打了招呼。', ko: '소년은 창가로 가서 바구니를 정리하던 채집인에게 말을 걸었다.' },
