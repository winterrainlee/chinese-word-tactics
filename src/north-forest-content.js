  ...
  Object.assign(globalThis.JourneyContent.STORIES, {
    'north-forest-signs-request': {
      ...
      background: 'inn', placeZh: '客棧', placeKo: '여관 게시판', beats: [
        { speaker: 'innkeeper', zh: '這是常來市集的採集人留下的。他平常就在北邊森林外圍活動。', ko: '장터에 자주 오는 채집인이 남긴 거야. 평소 북쪽 숲 바깥쪽에서 일하지.' },
        { speaker: 'boy', zh: '我上次找月白菇的地方，也在那附近嗎？', ko: '지난번 월백버섯 찾던 곳도 그 근처예요?' },
        { speaker: 'innkeeper', zh: '差不多。你去過一次，應該認得入口。', ko: '대충 그쪽이야. 한번 다녀왔으니 입구 정도는 알아보겠지.' },
        { speaker: 'collector', zh: '你就是幫客棧找月白菇的孩子？不用走遠，幫我看看外圍幾個標記就行。', ko: '네가 여관의 월백버섯을 찾아온 아이구나? 멀리 갈 필요 없어. 바깥쪽 표식 몇 개만 봐 줘.' },
        { speaker: 'boy', zh: '對。不過我對這裡還不熟。', ko: '네. 그래도 이쪽은 아직 잘 몰라요.' },
