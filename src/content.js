...
const WORLD={
  ...
  regions:[
    ...
    {id:'academic-tower',name:'學術塔',nameKo:'학술탑',icon:'region-research-city',subtitle:'기록의 관계를 연구하는 탑',status:'locked',requires:'chapter1-complete',note:'1장의 여행을 마치면 장인골에서 얻은 단서를 따라 방문할 수 있다.',targets:['卻','然而','果然','竟然','反而']}
  ]
};
