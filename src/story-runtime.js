(() => {
  ...
  const speakers = { narrator: ['旁白', '이야기'], boy: ['少年', '소년'], merchant: ['行商阿姨', '행상 아주머니'], marketkeeper: ['市集管理人', '장터지기'], innkeeper: ['客棧主人', '여관 주인'], gatekeeper: ['守門人', '길지기'], driver: ['車夫', '수레꾼'], artisan: ['工匠', '장인'], resident: ['居民', '주민'], unknown: ['遠處的聲音', '멀리서 들리는 목소리'] };
