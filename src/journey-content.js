  ...
  const STORIES = {
    ...
    'gate-bell-task': {
      ...
      beats: [
        ...
        { speaker: 'gatekeeper', zh: '我在路上立了幾支標記牌。走到標記旁，就能比較它和鐘樓的距離。', ko: '길에 표식을 몇 개 세워 뒀어. 표식 옆에 서면 감시탑까지 얼마나 떨어져 있는지 알 수 있지.' },
        { speaker: 'gatekeeper', zh: '幫我找找看，哪一個標記還聽得到鐘聲，而且離鐘樓最遠。', ko: '종소리가 아직 들리는 표식 중에서 감시탑과 가장 멀리 떨어진 곳을 찾아봐 줘.' },
    ...
    'gate-after-bell': {
      ...
      beats: [
        ...
        { speaker: 'boy', zh: '每個標記和鐘樓的距離都不一樣。把還聽得到鐘聲的地方連起來，就能看出它的範圍了。', ko: '표식마다 감시탑과의 거리가 달랐어요. 그래도 종소리가 들리는 곳을 이어 보니 범위가 어디까지인지 알겠어요.' },
    ...
    'gate-cart-task': {
      ...
      beats: [
        ...
        { speaker: 'boy', zh: '您先別推。我來看看貨車現在的位置，還有周圍的情況。', ko: '잠깐만 그대로 계세요. 수레가 어디에 서 있는지, 주변에 무엇이 있는지부터 살펴볼게요.' },
