  ...
  Object.assign(stories, {
    ...
    'workshop-w3-setup': {
      ...
      beats: [
        ...
        { speaker: 'boy', zh: '右邊的吊輪在轉，可是上面什麼也沒掛。', ko: '오른쪽 도르래는 돌고 있는데, 걸려 있는 게 아무것도 없네요.' },
    ...
    'workshop-after-w3': {
      ...
      background: 'workshop', placeZh: '工坊谷', placeKo: '장인골',
      beats: [
        { speaker: 'narrator', zh: '磨輪接上主軸後轉了起來，空著的吊輪則和主軸分開，慢慢停下。中央木輪一直照常轉著。', ko: '숫돌은 주축과 연결되자 돌기 시작했고, 비어 있던 도르래는 주축에서 분리되어 천천히 멈췄다. 가운데 작업바퀴는 계속 정상적으로 돌았다.' },
