...
- 현재 기반: **v0.6 이야기·여정 + 물길마을 그림지도 + 장소별 자유 의뢰**
- 목표 기기: iPhone 13 mini Safari 세로 화면
- 배포: GitHub Pages
- 현재 구현: 튜토리얼 6판 + 물길마을 도착 흐름 + 길목 G1~G7 + 장인골 W1~W7 + 장터 M1~M8 + 여관 방 MVP + 1장 결말 + 북쪽 숲 첫 자유 의뢰
- v1.0 목표: **물길마을의 첫 여행** — 세 갈래의 완결, 돌아올 여관, 첫 자유 의뢰
- 바로 다음 단계: **저장 내보내기·복원(Q05)**. 이후 빈 저장부터 1장 결말과 첫 자유 의뢰까지 대표 경로를 다시 완주한다.
