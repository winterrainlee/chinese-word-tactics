...
- 바로 다음 단계: **Q05 iPhone Safari 저장 내보내기·복원 실기기 확인**. 이후 전 콘텐츠를 최종 윤문하고 빈 저장부터 1장 결말과 첫 자유 의뢰까지 대표 경로를 다시 완주한다(Q07).
...
10. 제목 화면과 게임 메뉴에서 들어가는 **설정**을 열고, 현재 게임이 소유한 저장 영역만 버전이 있는 JSON으로 내보내고 검사·미리보기 뒤 복원할 수 있게 했다.
